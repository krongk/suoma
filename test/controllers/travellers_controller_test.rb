...
class TravellersControllerTest < ActionController::TestCase
  ...
  test "should create traveller" do
    assert_difference('Traveller.count') do
      post :create, traveller: { id_card: @traveller.id_card, is_kid: @traveller.is_kid, mobile: @traveller.mobile, name: @traveller.name, traveller_group_id: @traveller.traveller_group_id }
    end
  ...
  test "should update traveller" do
    patch :update, id: @traveller, traveller: { id_card: @traveller.id_card, is_kid: @traveller.is_kid, mobile: @traveller.mobile, name: @traveller.name, traveller_group_id: @traveller.traveller_group_id }
    assert_redirected_to traveller_path(assigns(:traveller))
  end
