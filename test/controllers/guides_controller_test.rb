...
class GuidesControllerTest < ActionController::TestCase
  ...
  test "should create guide" do
    assert_difference('Guide.count') do
      post :create, guide: { is_published: @guide.is_published, license_number: @guide.license_number, mobile: @guide.mobile, name: @guide.name, qq: @guide.qq, wechat: @guide.wechat }
    end
  ...
  test "should update guide" do
    patch :update, id: @guide, guide: { is_published: @guide.is_published, license_number: @guide.license_number, mobile: @guide.mobile, name: @guide.name, qq: @guide.qq, wechat: @guide.wechat }
    assert_redirected_to guide_path(assigns(:guide))
  end
