class TravellersController < ApplicationController
  before_action :set_traveller_group
  ...
  def create
    ...
    respond_to do |format|
      if @traveller.save
        format.html { redirect_to edit_traveller_group_path(@traveller_group), notice: 'Traveller was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @traveller.update(traveller_params)
        format.html { redirect_to edit_traveller_group_path(@traveller_group), notice: 'Traveller was successfully updated.' }
  ...
  private
    ...
    def set_traveller_group
      @traveller_group = TravellerGroup.find(params[:traveller_group_id])
    end

    # Never trust parameters from the scary internet, only allow the white list through.
    def traveller_params
      params.require(:traveller).permit(:traveller_group_id, :name, :mobile, :id_card, :is_kid)
    end
end
